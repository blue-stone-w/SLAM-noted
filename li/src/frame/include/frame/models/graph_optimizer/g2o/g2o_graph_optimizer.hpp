...
#ifndef FRAME_MODELS_GRAPH_OPTIMIZER_G2O_G2O_GRAPH_OPTIMIZER_HPP_
#define FRAME_MODELS_GRAPH_OPTIMIZER_G2O_G2O_GRAPH_OPTIMIZER_HPP_
...
#include "frame/models/graph_optimizer/g2o/edge/edge_se3_priorxyz.hpp"
#include "frame/models/graph_optimizer/g2o/edge/edge_se3_priorquat.hpp"
#include "frame/models/graph_optimizer/interface_graph_optimizer.hpp"
  ...
  class G2oGraphOptimizer: public InterfaceGraphOptimizer {
    public:
      ...
      private:
        ...
        void AddRobustKernel(g2o::OptimizableGraph::Edge *edge, const std::string &kernel_typr, double kernel_size);
