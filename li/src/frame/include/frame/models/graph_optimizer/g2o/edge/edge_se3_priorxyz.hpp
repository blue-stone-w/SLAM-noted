/*
Description: GNSS坐标做观测时使用的先验边
Author     : Wang Junpeng
date       : 
*/

#ifndef FRAME_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_SE3_PRIORXYZ_HPP_
#define FRAME_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_SE3_PRIORXYZ_HPP_
